...
public class Programme_10_TubeLine_Advanced {
    public static void main(String[] args) {
        ...
        do {
            //JFrame and JOptionPane is used for display Dialog and take input from users.
            ...
            b = JOptionPane.showInputDialog(frame, "Do you want to try again then please press Y",
                    "Press Y Or N", JOptionPane.WARNING_MESSAGE).toLowerCase();
